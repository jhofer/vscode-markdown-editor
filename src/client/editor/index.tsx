...
class RichMarkdownEditor extends React.PureComponent<Props, State> {
  ...
  componentDidUpdate(prevProps: Props) {
    ...
    // Only update if the incoming value is actually different from current editor content
    // This prevents cursor position loss when the same content comes back from the host
      ...
      [
        ...[
          ...
          new Image({
            ...
            onShowToast: this.props.onShowToast,
            onGetImageData: this.props.onGetImageData,
          }),
          new Table(),
          new TableCell({
